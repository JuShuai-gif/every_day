...
| --- | --- | --- | --- | --- | --- |
| [2026-09-14](2026-09-14/README.md) | C++ 工程知识（补充历史） | 控制帧单调内存池：对齐/placement new 与 RAII/析构登记/异常安全 | [frame_arena.hpp](2026-09-14/src/frame_arena.hpp)；[测试与基准](2026-09-14/src/main.cpp) | Mac Release 与 ASan/UBSan 实际编译运行通过；4 项正确性检查通过 | 20 预热+100 次，256 对象/帧：Release arena P50/P95 2.75/3.25 us，heap 对照 11/13.083 us；仅 CPU 微基准。[日志](2026-09-14/results/verification.md) |
